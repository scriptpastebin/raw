-- Disable hit VFX (damage highlight) before the attack module loads
pcall(function()
	local Modules = game:GetService("ReplicatedStorage"):WaitForChild("Modules", 10);
	if not Modules then
		return;
	end;
	local CombatUtil = Modules:WaitForChild("CombatUtil", 10);
	if not CombatUtil then
		return;
	end;
	local CU = require(CombatUtil);
	if type(CU) == "table" then
		CU.ApplyDamageHighlight = function() end;
	end;
end);
...
-- Refresh cached character refs setiap respawn, kalau tidak loop farm terus
-- nunjuk ke character mati dan auto farm berhenti setelah mati
...
local L = 0;
local P = 25;
local MasteryHealthPct = 70;
local MasteryAimbot = false;
local DoubleAttack = false;
local SwordMasteryLock = 200;
local SelectedSwordName = nil;
local AutoSwitchSword = false;
local BossNotify = false;
local RareIslandNotify = false;
local ServerHopFunc = "Auto Farm Level";
repeat
...
spawn(function()
	pcall(function()
		workspace.Enemies.DescendantAdded:Connect(function(R)
			pcall(function()
				if R:IsA("Fire") or R:IsA("Smoke") or R:IsA("Sparkles") then
					R.Enabled = false;
					if R:IsA("Fire") then R.Size = 0; R.Heat = 0; end;
		...
		while task.wait(.5) do
			for _, enemy in pairs(workspace.Enemies:GetDescendants()) do
				if enemy:IsA("Fire") or enemy:IsA("Smoke") or enemy:IsA("Sparkles") then
					pcall(function()
						enemy.Enabled = false;
						if enemy:IsA("Fire") then enemy.Size = 0; enemy.Heat = 0; end;
					end);
				end;
			end;
		end;
...
LowCpu = function()
		...
		if sethiddenproperty then
			pcall(sethiddenproperty, n, "Technology", "Compatibility")
			pcall(sethiddenproperty, n, "ShadowQuality", "Low")
		end
...
-- LowCpu tidak dijalankan otomatis, panggil manual kalau butuh: LowCpu()
CheckF = function()
		...
		pcall(function()
			if _G.SailBoat_Hydra or _G.WardenBoss or _G.AutoFactory or _G.HighestMirage or _G.HCM or _G.PGB or _G.Leviathan1 or _G.UPGDrago or _G.Complete_Trials or _G.TpDrago_Prehis or _G.BuyDrago or _G.AutoFireFlowers or _G.DT_Uzoth or _G.AutoBerry or _G.Prehis_Find or _G.Prehis_Skills or _G.Prehis_DB or _G.Prehis_DE or _G.FarmBlazeEM or _G.Dojoo or _G.CollectPresent or _G.AutoLawKak or _G.TpLab or _G.AutoPhoenixF or _G.AutoFarmChest or _G.AutoHytHallow or _G.LongsWord or _G.BlackSpikey or _G.AutoHolyTorch or _G.TrainDrago or _G.AutoSaber or _G.FarmMastery_Dev or _G.CitizenQuest or _G.AutoEctoplasm or _G.KeysRen or _G.Auto_Rainbow_Haki or _G.obsFarm or _G.AutoBigmom or _G.Doughv2 or _G.AuraBoss or _G.Raiding or _G.Auto_Cavender or _G.TpPly or _G.Bartilo_Quest or _G.Level or _G.FarmEliteHunt or _G.AutoZou or _G.AutoFarm_Bone or (getgenv()).AutoMaterial or _G.CraftVM or _G.FrozenTP or _G.TPDoor or _G.AcientOne or _G.AutoFarmNear or _G.AutoRaidCastle or _G.DarkBladev3 or _G.AutoFarmRaid or _G.Auto_Cake_Prince or _G.Addealer or _G.TPNpc or _G.TwinHook or _G.FindMirage or _G.FarmChestM or _G.Shark or _G.TerrorShark or _G.Piranha or _G.MobCrew or _G.SeaBeast1 or _G.FishBoat or _G.AutoPole or _G.AutoPoleV2 or _G.Auto_SuperHuman or _G.AutoDeathStep or _G.Auto_SharkMan_Karate or _G.Auto_Electric_Claw or _G.AutoDragonTalon or _G.Auto_Def_DarkCoat or _G.Auto_God_Human or _G.Auto_Tushita or _G.AutoMatSoul or _G.AutoKenVTWO or _G.AutoSerpentBow or _G.AutoFMon or _G.Auto_Soul_Guitar or _G.TPGEAR or _G.AutoSaw or _G.AutoTridentW2 or _G.Auto_StartRaid or _G.AutoEvoRace or _G.AutoGetQuestBounty or _G.MarinesCoat or _G.TravelDres or _G.Defeating or _G.DummyMan or _G.Auto_Yama or _G.Auto_SwanGG or _G.SwanCoat or _G.AutoEcBoss or _G.Auto_Mink or _G.Auto_Human or _G.Auto_Skypiea or _G.Auto_Fish or _G.CDK_TS or _G.CDK_YM or _G.CDK or _G.AutoFarmGodChalice or _G.AutoFistDarkness or _G.AutoMiror or _G.Teleport or _G.AutoKilo or _G.AutoGetUsoap or _G.Praying or _G.TryLucky or _G.AutoColShad or _G.AutoUnHaki or _G.Auto_DonAcces or _G.AutoRipIngay or _G.DragoV3 or _G.DragoV1 or _G.SailBoats or NextIs or _G.FarmGodChalice or _G.IceBossRen or senth or senth2 or _G.Lvthan or _G.beasthunter or _G.DangerLV or _G.Relic123 or _G.tweenKitsune or _G.Collect_Ember or _G.AutofindKitIs or _G.snaguine or _G.TwFruits or _G.tweenKitShrine or _G.Tp_LgS or _G.Tp_MasterA or _G.tweenShrine or _G.FarmMastery_G or _G.FarmMastery_S then
				...
				if not d.Character:FindFirstChild("highlight") then
					...
					Y.Name = "highlight";
					Y.Enabled = true;
					Y.FillColor = Color3.fromRGB(255, 215, 0);
...
local Fz = {
		...
		["Dropdown Selected Check Color"] = Color3.fromRGB(255, 215, 0),
...
gz.Image = "rbxassetid://5009915795";
...
iz.Thickness = .6;
iz.Color = Color3.fromRGB(255, 215, 0);
...
local Uz = function(Y)
		...
		local g = D .. ("," .. (A .. ("," .. u)));
		K.Text = "<font color=\"rgb(" .. (g .. (")\">Banana Hub</font> " .. dz.TitleNameNoti));
...
function Kz.CreateMain(Y)
	...
	local v = i .. ("," .. (U .. ("," .. C)));
	M.Text = "<font color=\"rgb(" .. (v .. ")\">Banana Hub </font> : Blox Fruits");
	...
	local S = b .. ("," .. (c .. ("," .. H)));
	M.Text = "<font color=\"rgb(" .. (S .. ")\">Banana Hub </font> : Blox Fruits");
	K.Name = "Background1";
	K.Parent = g;
	...
	function V.T(Y)
		...
		function S.CreateSection(Y, d, R, r)
			...
			function i.CreateToggle(Y, d)
				...
				n.BackgroundColor3 = Color3.fromRGB(255, 215, 0);
			...
			function i.CreateButton(Y, d)
				...
				I.SelectionOrder = 0;
				I.BackgroundColor3 = Color3.fromRGB(255, 215, 0);
				...
				N.Color = ColorSequence.new({ ColorSequenceKeypoint.new(.0, Color3.fromRGB(255, 215, 0)), ColorSequenceKeypoint.new(1.0, Color3.fromRGB(255, 215, 0)) });
				...
				D.TextScaled = false;
				D.BackgroundColor3 = Color3.fromRGB(255, 215, 0);
				...
				g.SliceScale = 1;
				g.BorderSizePixel = 1;
				g.BackgroundColor3 = Color3.fromRGB(255, 215, 0);
	...
	while task.wait(.1) do
		if _G.Level then
			pcall(function()
				...
				local Hum = i and i:FindFirstChildOfClass("Humanoid");
...
IF.CreateSlider({
	...
	Description = "Switches to fruit moves when NPC HP drops below this percent",
	Min = 10,
	Max = 95,
	Default = 70,
	Callback = function(Y)
...
IF.CreateToggle({
	...
	Description = "Auto-aims fruit skills at the NPC during mastery farming",
	Default = false,
	Callback = function(Y)
		MasteryAimbot = Y;
	end,
...
IF.CreateToggle({
	Title = "Double Attack (Fruit M1 + Melee M1)",
	Description = "Alternates fruit M1 and melee M1 on nearest enemy",
	Default = false,
	Callback = function(Y)
		DoubleAttack = Y;
	end,
		...
		if DoubleAttack then
			pcall(function()
				...
				for _, en in pairs(workspace.Enemies:GetChildren()) do
					if en:FindFirstChild("Humanoid") and en.Humanoid.Health > 0 and en:FindFirstChild("HumanoidRootPart") then
						local mag = (en.HumanoidRootPart.Position - d.Character.HumanoidRootPart.Position).Magnitude;
						if mag < best then best = mag; target = en; end;
					end;
				end;
				if target then
					MousePos = target.HumanoidRootPart.Position;
					weaponSc("Blox Fruit");
		...
		if _G.FarmMastery_Dev then
			pcall(function()
				if SelectIsland == "Cake" then
					...
					if Y then
						HealthM = (Y.Humanoid.MaxHealth * MasteryHealthPct) / 100;
						repeat
							wait();
							MousePos = Y.HumanoidRootPart.Position;
...
local SF = vz.CreateSection("Sword Mastery");
SF.CreateDropdown({
	Title = "Sword Selection",
	Description = "Choose which sword to level up",
	Values = (function()
		local swords = {};
		pcall(function()
			for _, inv in pairs(Q.Remotes.CommF_:InvokeServer("getInventory")) do
				if type(inv) == "table" and inv.Type == "Sword" then
					table.insert(swords, inv.Name);
				end;
			end;
		end);
		if #swords == 0 then swords = {"No Swords Found"} end;
		return swords;
	end)(),
	Default = nil,
	Callback = function(Y)
...
SF.CreateSlider({
	...
	Description = "Stop farming this sword at this mastery level",
	Min = 1,
	Max = 600,
	Default = 200,
	Callback = function(Y)
...
SF.CreateToggle({
	...
	Description = "Auto-equips the selected sword and stops at mastery lock level",
	Default = false,
	Callback = function(Y)
		AutoSwitchSword = Y;
	end,
...
spawn(function()
	while wait(T) do
		if AutoSwitchSword and SelectedSwordName then
			pcall(function()
				for _, inv in pairs(Q.Remotes.CommF_:InvokeServer("getInventory")) do
					if type(inv) == "table" and inv.Type == "Sword" and inv.Name == SelectedSwordName then
						local mastery = tonumber(inv.Mastery) or 0;
						if mastery >= SwordMasteryLock then
							AutoSwitchSword = false;
							nz.Notify("Sword Mastery", SelectedSwordName .. " reached level " .. SwordMasteryLock, 5);
							return;
						end;
						if not GetBP(SelectedSwordName) then
							Q.Remotes.CommF_:InvokeServer("LoadItem", SelectedSwordName);
						end;
					end;
				end;
			end);
...
local BZ = vz.CreateSection("Notifications");
local BossStatusLabel = BZ.CreateLabel({ Title = "Boss Status:", Content = "Checking..." });
local EliteStatusLabel = BZ.CreateLabel({ Title = "Elite Hunter:", Content = "Checking..." });
BZ.CreateToggle({
	Title = "Boss Spawn Notification",
	Description = "Notifies you when a world boss spawns in this server",
	Default = false,
	Callback = function(Y)
		BossNotify = Y;
	end,
...
BZ.CreateToggle({
	Title = "Rare Island Spawn Notification",
	Description = "Notifies you when Mirage/Kitsune Island spawns",
	Default = false,
	Callback = function(Y)
		RareIslandNotify = Y;
	end,
...
spawn(function()
	...
	while wait(3) do
		pcall(function()
			local foundBoss = nil;
			for _, bname in ipairs(U) do
				local bm = GetConnectionEnemies(bname);
				if bm then foundBoss = bname; break; end;
			end;
			BossStatusLabel:SetDesc(foundBoss and ("🟢 " .. foundBoss .. " in server!") or "🔴 No Boss");
			if BossNotify and foundBoss and foundBoss ~= lastBoss then
				nz.Notify("Boss Spotted!", foundBoss .. " is in the server!", 8);
			end;
			lastBoss = foundBoss;

			local eliteHere = workspace.Enemies:FindFirstChild("Elite Hunter");
			EliteStatusLabel:SetDesc(eliteHere and "🟢 Elite Hunter PRESENT" or "🔴 No Elite Hunter");

			if RareIslandNotify then
				local mirage = workspace.Map:FindFirstChild("MirageIsland") or workspace.Map:FindFirstChild("Mirage Island");
				local kitsune = workspace.Map:FindFirstChild("KitsuneIsland") or workspace.Map:FindFirstChild("Kitsune Island");
				local rareName = mirage and "Mirage Island" or (kitsune and "Kitsune Island" or nil);
				if rareName and rareName ~= lastRare then
					nz.Notify("Rare Island!", rareName .. " has spawned!", 10);
				end;
				lastRare = rareName;
			end;
		end);
...
local BusoCurrentLabel = gF.CreateLabel({ Title = "Current Buso Color:", Content = "Loading..." });
local BusoRarityLabel  = gF.CreateLabel({ Title = "Auto Buso Rarity:", Content = "—" });
spawn(function()
	while wait(2) do
		pcall(function()
			local col = Q.Remotes.CommF_:InvokeServer("GetAuraOwner", d.Name);
			BusoCurrentLabel:SetDesc(col or "None");
		end);
	end;
end);
gF.CreateDropdown({
	Title = "Auto Buy Buso Color",
	Description = "Teleport to Barista and buy this Buso color tier",
	Values = { "Random", "Rare", "Epic", "Legendary" },
	Default = "Random",
	Callback = function(Y)
		BusoRarityLabel:SetDesc(Y);
		pcall(function()
			for _, npc in pairs(Q.NPCs:GetChildren()) do
				if npc.Name == "Barista Cousin" then
					_tp(npc.HumanoidRootPart.CFrame * CFrame.new(0, 0, 3));
					wait(.5);
				end;
			end;
			local tier = Y == "Rare" and "1" or (Y == "Epic" and "2" or (Y == "Legendary" and "3" or "2"));
			Q.Remotes.CommF_:InvokeServer("ColorsDealer", tier);
		end);
	end,
});
gF.CreateToggle({
...
-- CreateDropdown tidak pernah manggil Callback untuk nilai Default, jadi
-- _G.SelectChip masih nil sampai user klik manual walaupun UI nampilin "Flame".
...
spawn(function()
	while wait(T) do
		if _G.AutoSelectDungeon then
			pcall(function()
				-- Kalau chip udah ke beli, jangan overwrite pilihan user.
				if GetBP("Special Microchip") then return end;
				-- Prioritas: fruit langka duluan (Buddha, Dough, Phoenix, Sand),
				-- sisanya urut popularitas. Kalau gak punya salah satu,
				-- JANGAN override ke Ice — biarin _G.SelectChip apa adanya.
				if GetBP("Human-Human: Buddha Fruit") then
...
-- Anti-spam: cooldown 2 detik antar klik tombol Beli biar gak kena rate-limit.
_LastBeliBuy = 0;
dq.CreateButton({ Title = "Buy Dungeon Chips [Beli]", Callback = function()
		if GetBP("Special Microchip") or not _G.SelectChip then
			return;
		end;
		if os.clock() - (_LastBeliBuy or 0) < 2 then
			return;
		end;
		_LastBeliBuy = os.clock();
		pcall(function()
...
dq.CreateButton({ Title = "Buy Dungeon Chips [Devil Fruit]", Callback = function()
		...
		pcall(function()
			for Y, R in next, (Q:WaitForChild("Remotes")).CommF_:InvokeServer("GetFruits") do
				if R.Price <= 490000 then
					Q.Remotes.CommF_:InvokeServer("LoadFruit", tostring(R.Name));
					task.wait(.5);
					Q.Remotes.CommF_:InvokeServer("RaidsNpc", "Select", _G.SelectChip);
					break;
				end;
		...
		pcall(function()
			if _G.Auto_StartRaid then
				if d.PlayerGui.Main.TopHUDList.RaidTimer.Visible == false then
					-- Gate: chip udah dibeli -> aman start raid.
					if GetBP("Special Microchip") then
						...
						elseif World3 then
							Q.Remotes.CommF_:InvokeServer("requestEntrance", Vector3.new(-5097.93164, 316.447021, -3142.66602, -0.405007899, -4.31682743e-08, .914313197, -1.90943332e-08, 1, 3.8755779e-08, -0.914313197, -1.76180437e-09, -0.405007899));
							_tp(CFrame.new(-5097.93164, 316.447021, -3142.66602, -0.405007899, -4.31682743e-08, .914313197, -1.90943332e-08, 1, 3.8755779e-08, -0.914313197, -1.76180437e-09, -0.405007899));
							wait(1);
...
cq.CreateDropdown({
	Title = "Server Hop Function",
	Description = "Auto hops servers and re-enables this function after join",
	Values = {
		"Auto Farm Level",
		"Auto Farm Nearest",
		"Auto Mastery Fruits",
		...
		"Auto Rainbow Colors",
		"Auto Cake Prince",
		"Double Attack (Fruit M1 + Melee M1)",
		"None",
	},
	Default = "None",
	Callback = function(Y)
...
cq.CreateButton({ Title = "Hop + Resume Function", Callback = function()
		if ServerHopFunc ~= "None" then
			nz.Notify("Server Hop", "Hopping and will resume: " .. ServerHopFunc, 5);
		end;
		wait(.5);
		Hop();
	end });
...
end);				elseif GetBP("Flame-Flame") then
ight) before the attack module loads
pcall(function()
	local Modules = game:GetService("ReplicatedStorage"):WaitForChild("Modules", 10);
	if not Modules then
		return;
